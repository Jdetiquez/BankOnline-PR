    ...
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles PictureBox1.Click
        ...
        If Double.TryParse(txtAmount.Text, amount) Then
            Try
                ...
                ' Update the transaction history with the deposit details.
                Dim transactionDetails As String = $"Mr./Mrs. {username} Deposited ${amount} on {DateTime.Now}"
                ...
                ' Close the deposit form and update the balance label in Form3.
                Me.Close()
